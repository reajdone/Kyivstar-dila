...
public class TestDataBaseConfig {
    ...
    private static final String PROPERTY_NAME_DATABASE_URL = "jdbc:mysql://localhost:3306/mobile";
    private static final String PROPERTY_NAME_DATABASE_USERNAME = "sa";
    private static final String PROPERTY_NAME_DATABASE_PASSWORD = "191291";
